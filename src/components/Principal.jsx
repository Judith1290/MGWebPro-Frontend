...
//     // const handleGoToPayment = async (producto, cantidad) => {
//     //     // console.log('Producto:', producto, 'Cantidad:', cantidad);
//     //     try {
//     //         await pagopos({ producto: producto, cantidad: cantidad });
//     //     } catch (error) {
...
const Principal = () => {
    ...
    const [searchTerm, setSearchTerm] = useState('');
    const [usuario, setUsuario] = useState(null);
    const [cantidadProductos, setCantidadProductos] = useState({}); // Estado para manejar las cantidades
